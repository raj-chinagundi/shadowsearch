// Real YouTube worker with actual video download and Gemini 2.5 Flash Lite
...
// Download YouTube video and prepare for Gemini 2.5 Flash Lite analysis
async function downloadVideo(env, { videoId = '', url = '' }) {
  try {
    ...
    // Download video as buffer for Gemini 2.5 Flash Lite
    console.log('[DownloadVideo] Downloading video for Gemini 2.5 Flash Lite...');
    ...
    return json({
      ...
      message: 'Video downloaded successfully for Gemini 2.5 Flash Lite analysis'
    });
...
// Analyze video using Gemini 2.5 Flash Lite with actual video content
async function analyzeVideo(env, { videoId = '', analysisType = 'comprehensive' }) {
  try {
    ...
    console.log('[AnalyzeVideo] Processing video with Gemini 2.5 Flash Lite, size:', videoInfo.videoBuffer.length, 'characters');
    ...
    try {
      ...
      // Create the content for Gemini 2.5 Flash Lite with actual video
      const content = [
        {
          text: prompt
        },
      ...
      console.log('[AnalyzeVideo] Gemini 2.5 Flash Lite response received');
      ...
      return json({
        ...
        message: 'Video analysis completed with Gemini 2.5 Flash Lite'
      });
...
// Generate YouTube-specific insights using Gemini 2.5 Flash Lite
async function youtubeInsights(env, { videoId = '', analysis = {} }) {
  try {
    ...
    try {
      ...
      console.log('[YouTubeInsights] Sending to Gemini 2.5 Flash Lite...');
      ...
      console.log('[YouTubeInsights] Gemini 2.5 Flash Lite response received');
      ...
      return json({
        success: true,
        insights: resultData,
        message: 'YouTube insights generated successfully with Gemini 2.5 Flash Lite'
      });
